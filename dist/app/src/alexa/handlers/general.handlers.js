...
module.exports = Alexa.CreateStateHandler(States.GENERAL, {
    ...
    'deleteProductsIntent': function () {
        ...
        this.emit(':ask', "<audio src='https://www.jovo.tech/audio/aaU4YRxc-output1.mp3' /> aber ich habe alle produkte weggeschmissen!");
    },
    'addProductIntent': function () {
        ...
        return initializePromise.then(function (result) {
            ...
            var temp = callTemplate.getTemplate(result.items[0].link);
